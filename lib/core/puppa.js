...
log2console = function(message) {
    var stack = new Error().stack.replace("Error", "Stack");
    jq_logger.log(stack);
...
var elem = async function (selector, promiseHandle, options) {
    ...
    log2console('Running: elem selector: ' + selector + ' promiseHandle: ' + promiseHandle);
...
var felem = async function (selectorFunc, promiseHandle, options) {
    ...
    log2console('Running: elem selectorFunc: ' + selectorFunc + ' promiseHandle: ' + promiseHandle);
