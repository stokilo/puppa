...
var elem = async function (selector, promiseHandle, options) {
    ...
    jq_logger.clear();
    jq_logger.log(stack);
    jq_logger.success('Running: elem selector: ' + selector + ' promiseHandle: ' + promiseHandle);
...
var felem = async function (selectorFunc, promiseHandle, options) {
    ...
    jq_logger.clear();
    jq_logger.log(stack);
    jq_logger.success('Running: elem selectorFunc: ' + selectorFunc + ' promiseHandle: ' + promiseHandle);
